...
const meta = {
  date: "May 11, 2021",
  title: "Making a Nextjs Blog using MDX and Styled Components",
  slug: "making-a-nextjs-blog",
  author: "Michael Hall",
  description:
    "Make a static blog using NextJs, MDX, and Styled Components. Follow along with this tutorial and get a blog up and running in no time. Use styled-components to make markdown look great. MDX makes the HTML even easier.",
...
Previously I wanted to use markdown for a blog, but it really became a headache trying to incorporate it with my JSX. However, MDX really took care of that, being able to put JSX directly into the markdown file really eliminated any problems I had.
...
- \- [prism-react-renderer](https://npmjs.com/package/prism-react-renderer) - NOTE: this is only needed to style the `code` tags in your MDX files.

```
npm i --save styled-components babel-plugin-styled-components prism-react-renderer
```

Once these are installed again you will need another config file, this time for babel. Make a .babelrc folder and paste in something like:
...
That should be all to get going for mdx. Just use the .mdx file extension for your markdown folders.

## Prism-react-renderer

For those wanting to make your own code block sections you'll need to make a custom styled code.js component. You can copy and paste this example from thier docs.
